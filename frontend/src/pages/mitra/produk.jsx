            ...
            <div className="p-6 overflow-y-auto custom-scrollbar flex flex-col sm:flex-row gap-6 text-[14px]">
              ...
              <div className="flex-1 space-y-4">
                <div className="space-y-1">
                  ...
                  <input type="text" name="nama_produk" value={formData.nama_produk} onChange={handleInputChange} className="w-full border border-slate-300 rounded-[10px] px-3 py-2 text-slate-700 focus:outline-none focus:border-[#006638]" placeholder="Contoh: Beras Premium" />
                </div>
                <div className="space-y-1">
